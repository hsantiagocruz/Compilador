 ...
 * }
 */
var PALABRAS_RESERVADAS = [ "principal", "mover", "vacio", "define", "si","sino", "mientras", "iterar", "apagar", "girarALaIzquierda", 
...
var terminales = [ "principal", "(", ")", "Identificador", "vacio", "define", "{", "}", "si", "sino", "mientras", "OR", "AND", "NOT", "esCero", "Funcion_Booleana", 
        ...
        switch( typeof(Accion[a][s]) ){
            ...
            default:{
                ...
                if( tok_aux[ tok_actual ].value!=="Identificador" )
                    mensaje = "\nError: Símbolo " + tok_aux[ tok_actual ].value + " inesperado. Línea " + (tok_aux[ tok_actual ].ind_+1) 
                else
                    mensaje = "\nError: Símbolo " + tok_aux[ tok_actual ].name + " inesperado. Línea " + (tok_aux[ tok_actual ].ind_+1)
                return mensaje
            }
        }
